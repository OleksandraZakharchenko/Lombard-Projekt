...
const FETCH_ERROR_MESSAGE = "Coś poszło źle. Spróbujemy to zassać";
const SERVER_ERROR_MESSAGE = 'Przepraszamy. Ktoś majstrował przy serwerze API. Spróbuj ponownie później.';
