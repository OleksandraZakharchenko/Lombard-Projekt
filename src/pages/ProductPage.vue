    ...
    <BaseCard class="product-page__card" v-else>
      ...
      <div class="product-page__card-content">
        ...
        <div class="product-page__card-actions">
          <BaseHeading variant="h2">{{ product.price }} PLN</BaseHeading>
          <div class="product-page__card-actions-buy">
            ...
            <BaseButton
              ...
              mode="success"
              v-else
              >Już w koszyku</BaseButton
            >
          </div>
        </div>
        <div class="product-page__card-description">
          <BaseHeading variant="h3">Opis</BaseHeading>
          <p>
            {{ product.description }}
          </p>
        </div>
...
const likeBtnText = computed(() =>
  isProductLiked.value ? "Na Twojej liście życzeń" : "Dodaj do listy życzeń"
);
